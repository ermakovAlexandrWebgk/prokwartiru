...
foreach($arSeoLn as $seoLn)
{
    ...
    // if(strpos($seoLn["CONDITION"], "/прив€зка") !== FALSE && $seoLn["REAL_URL"] == $APPLICATION->GetCurPage(false))
    // {
    //     $arSeoLinks = false;
    //     break;
    // }
                ...
                <div class="bx_filter">
                    <div class="bx_filter_section">
                        <!--<div class="bx_filter_parameters_box active title">
                            <div class="bx_filter_parameters_box_title">¬ывод товаров</div>
                        </div>-->
                        ...
                        <?if (!substr_count($URL, "collections_")) {?>
                            <a href="/catalog/<?=$urlItems[2].'/collections_'.$urlItems[2]?>/">
                                <div class="bx_filter_parameters_box">ѕо коллекци€м</div>
                            </a>
                        <?}else{?>
                            <a href="/catalog/<?=$urlItems[2]?>/">
                                <div class="bx_filter_parameters_box">ѕо артикулам</div>
                            </a>
                        <?}?>
                    </div>
                </div>
...
global $sotbitSeoMetaTopDesc;//дл€ установки верхнего описани€
$this->SetViewTarget('sotbitSeoMetaTopDesc'); //помечаем область дл€ вывода с именем "sotbitSeoMetaTopDesc", им€ может быть любым, главное чтоб было уникальным
echo $sotbitSeoMetaTopDesc;//вывод верхнего описани€
$this->EndViewTarget();
?>
