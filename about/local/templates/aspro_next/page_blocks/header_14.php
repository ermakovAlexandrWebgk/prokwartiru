...
<header class="header-v13 header-wrapper">
				...
				<div class="row">
					...
					<div class="right-icons pull-right">
						...
						<div class="pull-right block-link">
							<?=CNext::ShowBasketWithCompareLink('with_price', 'lg', true, 'wrap_icon inner-table-block baskets');?>
						</div>
						<div class="pull-right">
							<div class="wrap_icon inner-table-block">
								<?=CNext::showCabinetLink(true, true, 'lg', true);?>
							</div>
						</div>
						<div class="pull-right">
							<div class="wrap_icon inner-table-block">
