...
<ul>
<?foreach($arResult as $itemIndex => $arItem):?>
	<li <?if($arItem["TEXT"]=="Обои в интерьере"||$arItem["TEXT"]=="Плитка в интерьере"||$arItem["TEXT"]=="Свет в интерьере"||$arItem["TEXT"]=="Наши работы"||$arItem["TEXT"]=="Мозаика в интерьере"):?>style="font-weight: bold;"<?endif?>>
