...
<!-- Доставка товара -->
<? 
    $delivery="<div style='margin: 10px 0 0px 0px;'><p>Срок поставки:</p><p><a href='/about/delivery/'><img src='".SITE_TEMPLATE_PATH."/images/delivery.png' title='Доставка' alt='Доставка'  style='width:45px; margin-top:5px; margin-right:10px; float:left;' /></a>";
...
<!-- Расчет -->
<? $calc="<div style='margin: 10px 0 0px 0px;'><p>Помощь в расчете:</p><p><a href='/about/contacts/'><img src='".SITE_TEMPLATE_PATH."/images/calc.png' title='Расчет' alt='Расчет'  style='width:20px; margin:0px 10px 0px 0px; float:left;' /></a>телефон: <b>+7(985) 155-17-55</b><br />почта: <b>info@prokwarti.ru</b><p></div>";?>
<?=$calc?>
<!-- Конец Расчет -->
...
<br /><br />
<!-- Конец Скидка -->
<div style="width:280px; float:left;"><p class="back"><a href="#" onclick="history.back(); return false;">Назад</a></p></div>
<!-- Шоурум -->
<? if($type_item['UF_SHOWROOM']) $showroom="<div style='margin: 20px 0 0px 0px;'><p><a href='/about/contacts/'><img src='".SITE_TEMPLATE_PATH."/images/eye.png' style='width:30px; margin-top:0px; margin-right:10px; margin-top:-7px; float:left;' /></a>данный товар можно посмотреть в нашем <a href='/about/contacts/'>шоу-руме</a></p></div>"; ?>
<?=$showroom?>
<!-- Конец Шоурум -->
<br />
</div>
