...
<!-- Заголовок -->
  <div class="item-title"><nobr><span>Арт.</span> <a href="<?=$arElement['DETAIL_PAGE_URL']?>" title="<?=$arElement['NAME']?>"><b><?=$arElement["NAME"]?></b></a></nobr><?=$sticker?></div>
<!-- Конец Заголовок -->
...
?-->
<!--?
	if($arParams["DISPLAY_COMPARE"]) $button_compare="<div class='catalog-item-links'><div class='buttons'><a href='javascript:;' onclick='addToCompare(this, 'В блокноте');'>В блокнот</a></div></div>";
?-->
<?$path=$arElement["COMPARE_URL"];?>
...
function Add22Basket(id) {
     $.ajax({
             type:'POST',
             url:'/catalog/oboi/?action=ADD2BASKET&id='+id+'&SECTION_ID=75'
            })
}
</script>
<!--?$path="?action=ADD2BASKET&id=344&SECTION_ID=75";?-->
<?if($arParams["DISPLAY_COMPARE"]):?>
<?$button_compare="<div class='catalog-item-links'><div class='buttons'><a href='javascript:;' onclick='Add22Compare();'>В блокнот</a></div></div>";?>
<?endif?>
...
<!-- Формирование и форматирование Описания для всплывающей карточки товара -->
	...
	<?$title_text="<table cellspacing='0' cellpadding='0' border='0' class='float-card'><tr><td class='left'>Артикул: <b class='big'><nobr>".$title."</nobr></b></td><td class='right'>".$button_compare."</td></tr><tr><td class='left'>Цена: ".$price."</td><td class='right'>".$button_buy."</td></tr><tr><td colspan='2'>Наличие: <b class='orange'>".$quantity."</b></td></tr><td colspan='2'>".$text."</td></tr></table>";?>
...
<!-- Картинка -->
<div class="item-image">
	<a rel="detail-images" href="<?=$arElement['DETAIL_PICTURE']['SRC']?>" title="<?=$title_text?>"><img src="<?=$arElement["PREVIEW_IMG"]["SRC"]?>" width="100px" alt="Арт. <?=$arElement["NAME"]?>" title="Арт. <?=$arElement["NAME"]?>" id="catalog_list_image_<?=$arElement['ID']?>" /></a>
</div>
<!-- Конец Картинка -->
...
<div class="catalog-item-links">
		...
		<?if ($arElement['CAN_BUY']):?>
			...
			<div class="buttons"><a href="javascript:;" class="catalog-item-buy<?/*catalog-item-in-the-cart*/?>" rel="nofollow"  onclick="Add22Basket(<?=$arElement['ID']?>);" id="catalog_add2cart_link_<?=$arElement['ID']?>"><?echo GetMessage("CATALOG_ADD")?></a></div>
