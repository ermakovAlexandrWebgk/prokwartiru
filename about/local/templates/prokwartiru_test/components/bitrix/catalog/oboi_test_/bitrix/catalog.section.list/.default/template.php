...
<?
  if($fabrika) {
    ...
    if($ar_itemFabrika = $itemFabrika->GetNext()){
      ...
      if(($ar_itemFabrika['NAME']=="Loymina")||($fabrika['NAME']=="Seabrook")) $page_title=$page_title."<a href='/about/discounts/'><img src='".SITE_TEMPLATE_PATH."/images/free.png' title='Бесплатная доставка' alt='Бесплатная доставка'  style='width:145px; height:30px; margin-bottom:-5px; margin-left:30px;' /></a>";
    }   
...
?>
  ...
  <?
    ...
    $listCatalogFabrika=CIBlockSection::GetList(array('name'=>'asc'), $arFilter, false, $arSelect=array('UF_FABRIKA', 'UF_NEWCATALOG', 'UF_HIT', 'UF_SALE', 'UF_DISCOUNT10')); //'left_margin'=>'asc'
  ...
  ?>
	...
	<div class="catalog-item">
	  ...
	  <div style='position: relative; top: -175px; left: -3px;'><? if($itemCatalogFabrika["UF_DISCOUNT10"]) echo("<span id='sale'>-10%</span>"); elseif($itemCatalogFabrika["UF_NEWCATALOG"]) echo("<span id='new'>NEW</span>"); elseif($itemCatalogFabrika["UF_HIT"]) echo("<span id='hit'>HIT</span>");  elseif($itemCatalogFabrika["UF_SALE"]) echo("<span id='sale'>SALE</span>"); else echo("<span id='lable'>&nbsp;</span>");?></div>
	</div>
<?
  }
?>
...
<? $numberFilter=0; ?>
  ...
  <?
    ...
    $listCatalogType=CIBlockSection::GetList(array('left_margin'=>'asc'), $arFilter, false, $arSelect=array('UF_FABRIKA', 'UF_NEWCATALOG', 'UF_HIT', 'UF_SALE', 'UF_DISCOUNT10'), Array("nPageSize"=>60)); 
  ...
  ?>
	<div class="catalog-item">
	  ...
	  <div style='position: relative; top: -175px; left: -3px;'><?if($itemCatalogType["UF_DISCOUNT10"]) echo("<span id='sale'>-10%</span>"); elseif($itemCatalogType["UF_NEWCATALOG"]) echo("<span id='new'>NEW</span>"); elseif($itemCatalogType["UF_HIT"]) echo("<span id='hit'>HIT</span>");  
 elseif($itemCatalogType["UF_SALE"]) echo("<span id='sale'>SALE</span>"); else echo("<span id='lable'>&nbsp;</span>");?></div>
	</div>
<?
  }
?>
