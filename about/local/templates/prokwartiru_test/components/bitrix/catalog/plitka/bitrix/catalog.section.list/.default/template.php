...
if($filter_structure) $arFilterDop=array_merge($arFilterDop, Array('UF_STRUCTURE' => $filter_structure));
//global $arFilterDop;
...
?>
  ...
  <?
    ...
    $listCatalogFabrika=CIBlockSection::GetList(array('name'=>'asc'), $arFilter, false, $arSelect=array('UF_FABRIKA', 'UF_NEWCATALOG', 'UF_HIT', 'UF_SALE', 'UF_DISCOUNT10', 'UF_DISCOUNT5', 'UF_SALE_PLITKA', 'UF_ACTION')); // array('left_margin'=>'asc')
    while($itemCatalogFabrika=$listCatalogFabrika->GetNext()) 
    {
      $numberFilter++;
$saleID="";
$sale="";
$saleID=$itemCatalogFabrika['UF_SALE_PLITKA'];
if($saleID){
...
else $arFilterMain=Array('ACTIVE' => 'Y', 'IBLOCK_ID' => $IBLOCK_ID, 'SECTION_ID' => Array(31, 83, 84, 85, 401, 1881, 1882, 1883, 4163));
$arFilterDop=Array();
$arFilterDop1=Array();
