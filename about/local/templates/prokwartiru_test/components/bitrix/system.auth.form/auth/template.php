...
<a href="<?=$arResult["AUTH_REGISTER_URL"]?>" onclick="return ShowLoginForm();"><img src="/contacts/images/map_s.gif" border="0" alt=""></a>

<?else:?>
<form action="<?=$arResult["AUTH_URL"]?>">
  <p><input type="image" src="/contacts/images/map_s.gif" alt="<?=GetMessage("AUTH_LOGOUT_BUTTON")?>"></p>
  <br />
  <p><?=$arResult["USER_NAME"]?> [<a href="<?=$arResult["PROFILE_URL"]?>" class="profile-link" title="<?=GetMessage("AUTH_PROFILE")?>"><?=$arResult["USER_LOGIN"]?></a>]</p>
