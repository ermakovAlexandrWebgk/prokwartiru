...
);?> </td><?endif?><td style="BORDER-BOTTOM-COLOR: ; BORDER-TOP-COLOR: ; BORDER-RIGHT-COLOR: ; VERTICAL-ALIGN: top; BORDER-LEFT-COLOR: ; border-image: initial" ><?$APPLICATION->IncludeComponent("bitrix:catalog", "catalog", array(
	"IBLOCK_TYPE" => "catalog",
	"IBLOCK_ID" => "5",
	"BASKET_URL" => "#",
	"ACTION_VARIABLE" => "action",
