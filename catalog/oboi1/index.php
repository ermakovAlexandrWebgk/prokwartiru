...
$APPLICATION->SetPageProperty("title", "Обои в интернет-магазине prokwarti.ru");
...
$APPLICATION->SetPageProperty("description", "Интернет-магазин современного интерьера  www.prokwarti.ru");
...
<div><!--a href="/catalog/oboi/oboi_filters.php?SECTION_ID=1" class="poisk"--><a href="/catalog/oboi/search.php" class="poisk" >ПОДБОР 
    <br />
