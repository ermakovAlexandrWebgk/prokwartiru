...
<?
	...
	if($SECTION_ID=="51") header('Location:/catalog/oboi/'); /* обои */
	if($SECTION_ID=="78") header('Location:/catalog/plitka/'); /* плитка */
	if($SECTION_ID=="140") header('Location:/catalog/mosaic/'); /* мозаика */
	if($SECTION_ID=="759") header('Location:/catalog/lights/'); /* свет */
	if($SECTION_ID=="1266") header('Location:/catalog/lepnina/'); /* лепнина */
