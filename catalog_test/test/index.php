...
<!--?if((($arIBlockSection['IBLOCK_SECTION_ID']=="") && ($_REQUEST['SECTION_ID'])) || ($_REQUEST['FABRIKA_ID'])):?-->
 <?if( (($_REQUEST['SECTION_ID']!="") && ($_REQUEST['SECTION_ID']!="76") && ($_REQUEST['SECTION_ID']!="86")) && ($_REQUEST['FABRIKA_ID']=="")):?> <?$APPLICATION->IncludeComponent(
...
<!-- ЕСЛИ НЕ ГЛАВНАЯ СТРАНИЦА РАЗДЕЛА ИНТЕРЬЕРЫ (тяжелый вариант) -->
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"LIST_PROPERTY_CODE" => array(0=>"CATALOG",1=>"INTERIER",2=>"NEWPRODUCT",3=>"ARTICUL",4=>"PROPERTY",5=>"SIZE",6=>"RAPPORT",7=>"UNIT",8=>"",),
		"INCLUDE_SUBSECTIONS" => "N",
		"LIST_META_KEYWORDS" => "-",
		"LIST_META_DESCRIPTION" => "-",
		"LIST_BROWSER_TITLE" => "-",
		"DETAIL_PROPERTY_CODE" => array(0=>"",1=>"ARTICUL",2=>"PROPERTY",3=>"SIZE",4=>"RAPPORT",5=>"UNIT",6=>"PROP1",7=>"PROP2",8=>"PROP3",9=>"",),
