...
// 	array(),
// 	array("ACTIVE"=>"Y", "IBLOCK_ID"=>$iblock_id, "CODE" => "FILTER_".strtoupper($section_code) )
// );
...
$db_enum_list = CIBlockProperty::GetPropertyEnum( "FILTER_".strtoupper($section_code), array($sort_field => $sort_order) );
while ($ar_enum_list = $db_enum_list->GetNext())
{
	arshow($ar_enum_list);

	$arResult["FILTER_ITEMS"][] = $ar_enum_list;
