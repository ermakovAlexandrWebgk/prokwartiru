...
if (empty($arRunErrors))
{
    ...
    $itemFields = array(
        ...
        'CATALOG_AVAILABLE', 'CATALOG_TYPE', 'PROPERTY_YANDEX_EXP'
    );
    $offerFields = array(
        'ID', 'IBLOCK_ID', 'IBLOCK_SECTION_ID', 'NAME',
        'PREVIEW_PICTURE', 'PREVIEW_TEXT', 'PREVIEW_TEXT_TYPE', 'DETAIL_PICTURE', 'DETAIL_PAGE_URL', 'PROPERTY_YANDEX_EXP'
    );
    ...
    $filter = array('IBLOCK_ID' => $IBLOCK_ID, 'PROPERTY_YANDEX_EXP' => false);
    ...
    $offersFilter = array('ACTIVE' => 'Y', 'ACTIVE_DATE' => 'Y', 'PROPERTY_YANDEX_EXP' => false);
    if ($filterAvailable)
