<?
//<title>yandexExp_Bitrix2018</title>
/** @global CDatabase $DB */
/** @global CUser $USER */
...
if ($STEP == 1)
{
    ...
    if (!isset($SETUP_FILE_NAME))
        $SETUP_FILE_NAME = 'yandex_export_prokwartu.ru.php';
...
?><tr>
    ...
    echo GetIBlockDropDownListEx(
        ...
        "ClearSelected(); changeIblockSites(0); BX('id_ifr').src='/bitrix/tools/catalog_export/yandexExp_Bitrix2018_util.php?IBLOCK_ID=0&'+'".bitrix_sessid_get()."';",
        "ClearSelected(); changeIblockSites(this[this.selectedIndex].value); BX('id_ifr').src='/bitrix/tools/catalog_export/yandexExp_Bitrix2018_util.php?IBLOCK_ID='+this[this.selectedIndex].value+'&'+'".bitrix_sessid_get()."';",
...
<tr>
    ...
    <iframe src="/bitrix/tools/catalog_export/yandexExp_Bitrix2018_util.php?IBLOCK_ID=<?=intval($IBLOCK_ID)?>&<? echo bitrix_sessid_get(); ?>" id="id_ifr" name="ifr" style="display:none"></iframe>
    </td>
</tr>
