...
<?
  if(CModule::IncludeModule("iblock")){
	...
	if($arSite=="/catalog/oboi/"||($arSite=="/catalog/interiers/" && ($sectionID==76))) $SECTION_ID=51; /* обои */
	if($arSite=="/catalog/plitka/"||($arSite=="/catalog/interiers/" && $_REQUEST["SECTION_ID"]==86)) $SECTION_ID=78; /* плитка*/
...
?>
	<li id="<?=$this->GetEditAreaId($arSection['ID']);?>">
         <img src="<?=$arSection['PICTURE']['SRC']?>" width="<?=$arSection['PICTURE']['WIDTH']?>" height=