...
<div class="product_wrapper <?=(!$showCustomOffer ? "noffer" : "");?> <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>" id="<?=$arItemIDs["strMainID"];?>" >

    <div class="product_main_info">

        <div class="image_block img_wrapper">
        ...
        <div class="product_info_wrapper">
            ...
            <div class="product_title"> Артикул: <?=$arResult["NAME"]?></div>
			...
			<div class="tabs_section">
				...
				<div class="tabs">
					<ul class="nav nav-tabs">
						...
						<?endif;?>
						<?if($arResult["DETAIL_TEXT"] || count($arResult["STOCK"]) || count($arResult["SERVICES"]) || ((count($arResult["PROPERTIES"][$instr_prop]["VALUE"]) && is_array($arResult["PROPERTIES"][$instr_prop]["VALUE"])) || count($arResult["SECTION_FULL"]["UF_FILES"])) || ($showProps && $arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB")):?>
												...
												<tr class="main_item_wrapper" id="<?=$this->GetEditAreaId($arSKU["ID"]);?>">
													...
													<td class="price">
														<div class="cost prices clearfix">
															...
															{?>
																<?=\Aspro\Functions\CAsproNextItem::getItemPrices($arParams, $arSKU["PRICES"], $arSKU["CATALOG_MEASURE_NAME"], $min_price_id);?>
															<?}?>
														</div>
													</td>
