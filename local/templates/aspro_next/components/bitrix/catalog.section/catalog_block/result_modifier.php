...
foreach ($arResult["ITEMS"] as $arItem) {
    ...
    $curr_section = $_REQUEST["current_section"];
    ...
    while ($item_props_info = $item_info -> Fetch()) {
        ...
        if (strlen($item_props_info["IBLOCK_SECTION_ID"])) {
            $section_info = CIBlockSection::GetByID($item_props_info["IBLOCK_SECTION_ID"]) -> Fetch();
