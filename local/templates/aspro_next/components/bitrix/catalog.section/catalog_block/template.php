...
<?foreach($arResult["ITEMS"] as $arItem){?>
            ...
            <div class="item_block col-<?=$col;?> col-md-<?=floor(12/$arParams["LINE_ELEMENT_COUNT"]);?> col-sm-<?=floor(12/round($arParams['LINE_ELEMENT_COUNT'] / 2))?> col-xs-6">
                <div class="catalog_item_wrapp item">
                    ...
                    $elementName = "јртикул: " . $arItem['NAME'];
                    ?>
                    <div class="catalog_item main_item_wrapper item_wrap <?=(($_GET['q'])) ? 's' : ''?>" id="<?=$arItemIDs["strMainID"];?>">
                        <div>
                                ...
                                <div class="stickers">
                                    ...
                                    <?if(!empty($arItem["PRICES"]["SALE"])){
                                            if (isset($arItem["PRICES"]["SALE"]["DISCOUNT_DIFF_PERCENT"]) && $arItem["PRICES"]["SALE"]["DISCOUNT_DIFF_PERCENT"] > 0){?>
                                                <div><div class="sticker_STOCK"><?='-'.$arItem["PRICES"]["SALE"]["DISCOUNT_DIFF_PERCENT"].'%'?></div></div>
                                        <?}?>
                                    <?}?>
                            ...
                            <div class="item_info <?=$arParams["TYPE_SKU"]?>">
                                ...
                                <div>
                                <span class="price_per_m2"><?=$arItem["PROPERTIES"]["PRICE_PER_M2"]["VALUE"].' р/м2';?></span>
                                </div>
                                <?}?>
