													...
													<?if($arPrice["CAN_ACCESS"]){
														...
														<div class="price only_price">
															<?if(strlen($arPrice["PRINT_VALUE"])):?>
																<span class="values_wrapper"><?=\Aspro\Functions\CAsproNextItem::getCurrentPrice("DISCOUNT_VALUE", $arPrice);?></span><?if (($arParams["SHOW_MEASURE"]=="Y") && $strMeasure){?><span class="measure">/<?=$strMeasure?></span><?}?>
															<?endif;?>
														</div>
													<?}?>
												<?}?>
