...
if (!strstr($APPLICATION->GetCurDir(), "/filter/") && $enabled_banners) {
    global $arFilterBanners;
    $arFilterBanners["PROPERTY_CATALOG_SECTION"] = $arResult["VARIABLES"]["SECTION_ID"];
    ?>
                ...
                <div class="bx_filter">
                    <div class="bx_filter_section">
                        ...
                        <?if (isset($_SESSION["view_by_collections"])) {?>
                            <a href="<?= $APPLICATION -> GetCurPage() ?>?view_by_items=Y"><div class="bx_filter_parameters_box">По артикулам</div></a>
                        <?} else {?>
                            <a href="<?= $APPLICATION -> GetCurPage() ?>?view_by_collections=Y"><div class="bx_filter_parameters_box">По коллекциям</div></a>
                        <?}?>
                    </div>
                </div>
            <?}?>
