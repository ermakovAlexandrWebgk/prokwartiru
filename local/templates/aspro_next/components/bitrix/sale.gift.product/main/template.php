										...
										<div class="cost prices clearfix">
											<?if( $arItem["OFFERS"]){?>
												...
												<?if($arParams["SHOW_OLD_PRICE"]=="Y"){?>
													<div class="price" data-currency="<?=$minPrice["CURRENCY"];?>" data-value="<?=$minPrice["DISCOUNT_VALUE"];?>" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PRICE']; ?>">
														<?if(strlen($minPrice["PRINT_DISCOUNT_VALUE"])):?>
															<?=$prefix;?> <span class="values_wrapper"><?=$minPrice["PRINT_DISCOUNT_VALUE"];?></span><?=$measure_block;?>
														<?endif;?>
													</div>
													<div class="price discount" data-currency="<?=$minPrice["CURRENCY"];?>" data-value="<?=$minPrice["VALUE"];?>" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['PRICE_OLD']; ?>">
														<strike <?=(!$minPrice["DISCOUNT_DIFF"] ? 'style="display:none;"' : '')?>><span class="values_wrapper"><?=$minPrice["PRINT_VALUE"];?></span></strike>
													</div>
													<?/*if($arParams["SHOW_DISCOUNT_PERCENT"]=="Y"){?>
														<div class="sale_block" <?=(!$minPrice["DISCOUNT_DIFF"] ? 'style="display:none;"' : '')?>>
															<span class="title"><?=GetMessage("CATALOG_ECONOMY");?></span> <div class="text"><span class="values_wrapper" data-currency="<?=$minPrice["CURRENCY"];?>" data-value="<?=$minPrice["DISCOUNT_VALUE"];?>"><?=$minPrice["PRINT_DISCOUNT_DIFF"];?></span></div>
															<div class="clearfix"></div>
														</div>
													<?}*/?>
												<?}else{?>
													<div class="price only_price" data-currency="<?=$minPrice["CURRENCY"];?>" data-value="<?=$minPrice["VALUE"];?>" id="<?=$arItemIDs["ALL_ITEM_IDS"]['PRICE']?>">
														<?if(strlen($minPrice["PRINT_DISCOUNT_VALUE"])):?>
															<?=$prefix;?> <span class="values_wrapper"><?=$minPrice['PRINT_DISCOUNT_VALUE'];?></span><?=$measure_block;?>
														<?endif;?>
													</div>
