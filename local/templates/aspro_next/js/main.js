            ...
            if(parent.hasClass('ajax')) // front tabs
            {
                if(!$(this).hasClass('clicked'))
                {
                    $.ajax({
                        ...
                        curLi.find('.catalog_block .catalog_item_wrapp .catalog_item .item_info:visible').sliceHeight({item:'.catalog_item:visible', resize: false});
