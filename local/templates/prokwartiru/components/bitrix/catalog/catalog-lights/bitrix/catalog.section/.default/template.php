...
<!-- Формирование и форматирование Описания для всплывающей карточки товара -->
	...
	<?$title_text="<table cellspacing='0' cellpadding='0' border='0' class='float-card' style='width: 350px;'><tr><td class='left'>Артикул: <b class='big'>".$title."</b></td><td class='right'>".$button_compare."</td></tr><tr><td class='left'>Цена: <span class='float-card-price'>".$price_print."</span> / шт.</td><td class='right'>".$button_buy."</td></tr><tr><td colspan='2'>Наличие: <b class='orange'>".$quantity."</b></td></tr><tr><td colspan='2'>".$text."</td></tr></table>";?>
