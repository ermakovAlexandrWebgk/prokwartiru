...
?>
	...
	<div class="catalog-item-card"  style="width: 136px;">
...
<?
	$button_buy="<div class='catalog-item-links'>";
	if ($arElement['CAN_BUY']) $button_buy=$button_buy."<div class='buttons'><a href='javascript:;' class='catalog-item-buy' rel='nofollow'  onclick='javascript:Add2Basket(&quot;".$arElement['ADD_URL']."&quot;);' id='catalog_add2cart_link_".$arElement['ID']."'>".GetMessage('CATALOG_ADD')."</a></div>";
	elseif (count($arResult['PRICES']) > 0) $button_buy=$button_buy."<span class='catalog-item-not-available'>".GetMessage('CATALOG_NOT_AVAILABLE')."</span>";
	$button_buy=$button_buy."</div>";
?>
...
<!-- Картинка -->
<div class="item-image" style="1px solid red; width: 130px;">
	<a rel="detail-images" href="<?if($arElement['DETAIL_PICTURE']['SRC']):?><?=$arElement['DETAIL_PICTURE']['SRC']?><?else:?><?=SITE_TEMPLATE_PATH?>/images/default300.gif<?endif?>" title="<?=$title_text?>"><img src="<?if($arElement['PREVIEW_IMG']['SRC']):?><?=$arElement['PREVIEW_IMG']['SRC']?><?else:?><?=SITE_TEMPLATE_PATH?>/images/default100.gif?><?endif?>" style="width: <?=$arElement['PREVIEW_IMG']['WIDTH']?>; height: <?=$arElement['PREVIEW_IMG']['HEIGHT']?>;" alt="Арт. <?=$arElement["NAME"]?>" title="Арт. <?=$arElement["NAME"]?>" id="catalog_list_image_<?=$arElement['ID']?>"/></a>
</div>
<!-- Конец Картинка -->
<!--?endif;?-->
