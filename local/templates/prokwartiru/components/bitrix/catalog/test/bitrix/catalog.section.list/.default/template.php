...
<?
	...
	$filter_new=$_REQUEST["NEW"];
	$filter_hit=$_REQUEST["HIT"];
...
$arFilterDop=Array();
//if($filter_price||$filter_width||$filter_new||$filter_hit) $arFilterDop=Array('UF_PRICE'=>$filter_price, 'UF_WIDTH'=>$filter_width, 'UF_NEWCATALOG'=>$filter_new, 'UF_HIT'=>$filter_hit);
//global $arFilterDop;
...
//if($filter_new) $arFilterDop=array_merge($arFilterDop, Array('UF_NEWCATALOG'=>true));
//if($filter_hit) $arFilterDop=array_merge($arFilterDop, Array('UF_HIT'=>true));
