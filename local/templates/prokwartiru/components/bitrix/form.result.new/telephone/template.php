	...
	?>
		<tr>
			<td>
				...
				<?endif;?>
				222<?=$FIELD_SID?> <?=$arQuestion["CAPTION"]?><?if ($arQuestion["REQUIRED"] == "Y"):?><?=$arResult["REQUIRED_SIGN"];?><?endif;?>
				<?=$arQuestion["IS_INPUT_CAPTION_IMAGE"] == "Y" ? "<br />".$arQuestion["IMAGE"]["HTML_CODE"] : ""?>
			</td>
			<td><?if($FIELD_SID=="TIME"):?><?$GLOBALS["APPLICATION"]->IncludeComponent(
	"bitrix:main.clock",
	"clock",
	Array(
		"INPUT_ID" => "time",
...
);?><!--?$arResult[NAME][0][USER_TEXT]="333"?--><? $arQuestion["HTML_CODE"]="333"?> <?else:?><?=$arQuestion["HTML_CODE"]?><?endif?>111</td>
		</tr>
	<? 
	} //endwhile 
	?>
