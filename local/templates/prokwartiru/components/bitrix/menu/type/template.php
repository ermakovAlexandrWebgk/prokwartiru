...
<div class="menu-type">
	...
	<div class="menu-type-item">    
            ...
            <?if($arItem['TEXT']=="Распродажа"):?><span class="sale"><?endif?><a href="<?=$arItem['LINK']?>" <?if($arItem['SELECTED']||($arItem['TEXT']==$sectionNAME)):?> class="on" <?endif?> ><nobr><?=$arItem["TEXT"]?></nobr></a><?if($arItem['TEXT']=="Распродажа"):?></span><?endif?>&nbsp;
	</div>
	<?endforeach;?>
