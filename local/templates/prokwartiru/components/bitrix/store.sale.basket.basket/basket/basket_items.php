        		...
        		<tr>
        			<?if (in_array("NAME", $arParams["COLUMNS_LIST"])):?>
        				<td class="cart-item-name">
                            ...
                            Арт. <?=$arBasketItems["SECTION_ID"]?><a href="<?=$arBasketItems["DETAIL_PAGE_URL"]?>"><b><?=$arBasketItems["NAME"]?></b></a><br />
...
?>
        			<?if (in_array("QUANTITY", $arParams["COLUMNS_LIST"])):?>
        				<td class="cart-item-quantity"><input maxlength="18" type="text" name="QUANTITY_<?=$arBasketItems["ID"] ?>" value="<?=$arBasketItems["QUANTITY"]?>" size="3">&nbsp;&nbsp;<?=$UNIT;?></td>
        			<?endif;?>
