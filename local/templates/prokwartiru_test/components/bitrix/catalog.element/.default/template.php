		...
		<?if (is_array($arResult['DETAIL_PICTURE_350']) || count($arResult["MORE_PHOTO"])>0):?>
			...
			<?if (is_array($arResult['DETAIL_PICTURE_350'])):?>
				<div class="catalog-detail-image" id="catalog-detail-main-image">
					<a rel="catalog-detail-images" href="<?=$arResult['DETAIL_PICTURE']['SRC']?>" title="<?=(strlen($arResult["DETAIL_PICTURE"]["DESCRIPTION"]) > 0 ? $arResult["DETAIL_PICTURE"]["DESCRIPTION"] : $arResult["NAME"])?>"><img src="<?=$arResult['DETAIL_PICTURE_350']['SRC']?>" alt="<?=$arResult["NAME"]?>" id="catalog_detail_image" width="250px<!--?=$arResult['DETAIL_PICTURE_350']['WIDTH']?-->" height="250px<!--?=$arResult['DETAIL_PICTURE_350']['HEIGHT']?-->" /></a>
				</div>
			<?endif;?>
...
?>
	<div class="catalog-detail-properties">
		<h4>Характеристики:<!--?=GetMessage('CATALOG_PROPERTIES')?--></h4>
		<div class="catalog-detail-line"></div>
