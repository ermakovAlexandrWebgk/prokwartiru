...
//		$arFilter = Array('UF_FABRIKA' => $itemFabrika['ID']);
//		$listCatalog = GetIBlockSectionList($TYPE_ID, Array("NAME"=>"ASC"), $arFilter);
...
//			$arFilter = Array("IBLOCK_ID" => 9, $PROPERTY =>$itemCatalog['ID']);
			$arFilter = Array($PROPERTY =>$itemCatalog['ID']);
//			$listElement = CIBlockElement::GetList(Array(), $arFilter, false, Array(), $arSelect);
			$listElement = GetIBlockElementList(9, Array("NAME"=>"ASC"), $arFilter);
