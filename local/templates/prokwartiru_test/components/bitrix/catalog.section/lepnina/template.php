...
?>
	...
	<div class="catalog-item-card" style="height: 200px;">
...
<!-- Формирование и форматирование Описания для всплывающей карточки товара -->
	...
	<?$title_text="<table cellspacing='0' cellpadding='0' border='0' class='float-card'><tr><td class='left' valign='bottom'><br /><p>".$button_buy."</p><p>".$button_compare."</p><br /></td></tr><tr><td class='left'><p>Артикул: <b class='big'>".$title."</b></p><p>Цена: ".$price."</p><p>Наличие: <b class='orange'>".$quantity."</b></p></td></tr><tr><td>".$text."</td></tr></table>";?>
