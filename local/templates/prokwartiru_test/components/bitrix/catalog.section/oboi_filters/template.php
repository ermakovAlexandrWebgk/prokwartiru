...
// ФИЛЬТР
$arFilterMain=Array("GLOBAL_ACTIVE"=>"Y", "ACTIVE" => "Y", "IBLOCK_ID"=>$iblock_ID, "PROPERTY_COLOR"=>$COLOR_ID, "PROPERTY_DESIGN"=>$DESIGN_ID);
//global $arFilterDop;
...
$section=GetIBlockSection($arElement["IBLOCK_SECTION_ID"], 'catalog');
  if($section&&($section['ID']!=881)) { 
    $type = CIBlockSection::GetList(array(), array('ACTIVE'=>'Y','IBLOCK_ID' => $iblock_ID, 'ID' => $section['ID']), false, $arSelect=array('UF_FABRIKA','UF_NEW','UF_GLUE','UF_SHOWROOM'));
