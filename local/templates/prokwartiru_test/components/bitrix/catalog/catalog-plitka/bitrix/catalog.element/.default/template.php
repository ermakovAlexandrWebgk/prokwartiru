...
<?
		...
		$text=$text."<br /><p><b>".$arResult['PROPERTIES']['PROPERTY']['VALUE']."</b></p>";
		$text=$text."<p>Размер: <b>".$arResult['PROPERTIES']['SIZE']['VALUE']."</b></p>";
		$text=$text."<p>Раппорт (подбор): <b>".$arResult['PROPERTIES']['RAPPORT']['VALUE']."</b></p>";	
		$text=$text."</div>";

		$text="<div class='catalog-detail-properties'>";
		$text=$text."<br /><p>Коллекция: <a href='".$APPLICATION->GetCurDir()."index.php?SECTION_ID=".$section["ID"]."'><b><u>".$section["NAME"]."</u></b></a></p>";
		$text=$text."<p>Артикул: <b>".$arResult['PROPERTIES']['ARTICUL']['VALUE']."</b></p>";	
