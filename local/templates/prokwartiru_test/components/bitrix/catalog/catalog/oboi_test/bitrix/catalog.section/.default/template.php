...
<!-- Формирование и форматирование Описания для всплывающей карточки товара -->
	...
	<?$title_text="<table cellspacing='0' cellpadding='0' border='0' class='float-card' style='min-width:400px;'><tr><td class='left'><p>Артикул: <b class='big'>".$title."</b></p><p>Цена: ".$price."</p></td></tr><tr><td>".$text."</td></tr><tr><td>".$discount.$delivery.$calc."</td></tr><tr><td class='left'>".$button_buy.$button_glue."</td></tr><tr><td valign='top' style='height: 30px;'>".$discount5."</td></tr><tr><td valign='bottom' style='height: 40px;'>".$showroom."</td></tr></table>";?>
