...
<?
	...
	if($arSite=="/catalog/interiers/" && ($SECTION_ID==3715||$SECTION_TOP==3715)) { $FABRIKI_TYPE_ID=51; $TYPE_ID=5; } /* фрески */
...
//echo($interierList[$i]['NAME']); echo(" ");
	      ...
	      if($arSite=="/catalog/interiers/" && ($SECTION_ID==3715||$SECTION_TOP==3715)) $path="/catalog/oboi/"; /* фрески */
?>
