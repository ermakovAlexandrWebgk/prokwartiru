		...
		<?if (is_array($arResult['DETAIL_PICTURE_350']) || count($arResult["MORE_PHOTO"])>0):?>
			...
			<?if (is_array($arResult['DETAIL_PICTURE_350'])):?>
				<div class="catalog-detail-image" id="catalog-detail-main-image">
					<a rel="catalog-detail-images" href="<?=$arResult['DETAIL_PICTURE']['SRC']?>" title="Арт. <?=$arResult["NAME"]?>"><img src="<?=$arResult['DETAIL_PICTURE_350']['SRC']?>" alt="<?=$arResult["NAME"]?>" id="catalog_detail_image" style="border: none;" /></a>
				</div>
			<?endif;?>
...
<?
		...
		$text=$text."<br /><p>Назначение: <a href='".$APPLICATION->GetCurDir()."index.php?SECTION_ID=".$section["ID"]."'><b><u>".$section["NAME"]."</u></b></a></p>";
...
<?$APPLICATION->SetTitle($section['NAME']." (".$fabrika['NAME'].") арт. ".$arResult['NAME']." в интернет-магазине www.prokwarti.ru");?>
