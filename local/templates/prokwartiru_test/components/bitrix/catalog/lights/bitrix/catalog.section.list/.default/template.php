...
<?if($fabrika):?>
  <?
    ...
    $listCatalogFabrika=CIBlockSection::GetList(array('name'=>'asc'), $arFilter, false, $arSelect=array('UF_FABRIKA', 'UF_NEWCATALOG', 'UF_HIT', 'UF_SALE', 'UF_PRICE')); //'left_margin'=>'asc'
...
<?else:?>
  ...
  <?
    $listCatalogType=CIBlockSection::GetList(array('name'=>'asc'), array('ACTIVE' => 'Y', 'IBLOCK_ID' => $IBLOCK_ID, 'SECTION_ID' => $section), false, $arSelect=array('UF_FABRIKA', 'UF_NEWCATALOG', 'UF_HIT', 'UF_SALE')); //'left_margin'=>'asc'
