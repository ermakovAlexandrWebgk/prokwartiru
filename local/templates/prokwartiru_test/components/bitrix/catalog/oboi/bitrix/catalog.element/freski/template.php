...
<?
  ...
  if($section) $type = CIBlockSection::GetList(array(), array('IBLOCK_ID' => $iblock_ID, 'ID' => $section['ID']), false, $arSelect=array('UF_FABRIKA','UF_NEWCATALOG', 'UF_HIT', 'UF_SALE', 'UF_SALE_OBOI'));
...
<br /><br/>Наличие: <?if($itemCatalog["QUANTITY"]>0):?><b class="orange">Складская программа</b><?else:?><b class="orange">Под заказ</b><?endif?>
