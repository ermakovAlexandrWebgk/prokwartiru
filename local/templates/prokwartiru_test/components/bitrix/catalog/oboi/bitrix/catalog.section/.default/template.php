...
<!-- Интерьеры -->
<?if(false):?>
<? $interiersNumber=5; if($section['ID']==842||$section['ID']==1812) $interiersNumber=1000; ?>
<?if($section&&($section['IBLOCK_SECTION_ID']!=49)){
...
<?
	if (is_array($arElement['DISPLAY_PROPERTIES']) && count($arElement['DISPLAY_PROPERTIES']) > 0){
		...
		if($arElement['PROPERTIES']['PROPERTY']['VALUE']) $text=$text."Основные характеристики:<br /><b>".$arElement['PROPERTIES']['PROPERTY']['VALUE']."</b><br />";
...
<? $look="<div style='margin: 20px 0 0px 0px;'><p><img src='".SITE_TEMPLATE_PATH."/images/look.png' style='width:28px; height:23px; margin-top:-5px; margin-right:10px; float:left;' /> <a href='/catalog/oboi/interiers.php?SECTION_ID=".$section["ID"]."' style='text-decoration:none;'><b>посмотреть в интерьере</b></a></p></div><div style='clear:both;'></div>"; ?>
