...
?>
	...
	<div class="catalog-item-card" style="height:180px;">


<!-- Заголовок -->
  <div class="item-title" style="height: 16px;"><span>Арт.</span> <a href="<?=$arElement['DETAIL_PAGE_URL']?>" title="<?=$arElement['NAME']?>"><b><?=$arElement["NAME"]?></b></a><?=$sticker?></div>
<!-- Конец Заголовок -->
...
<?
	if (is_array($arElement['DISPLAY_PROPERTIES']) && count($arElement['DISPLAY_PROPERTIES']) > 0){
		...
		if($arElement['PREVIEW_TEXT']) $text=$text."<br /><p>".$arElement['PREVIEW_TEXT']."</p>";
...
<!-- Формирование и форматирование Описания для всплывающей карточки товара -->
	...
	<?$title_text="<table cellspacing='0' cellpadding='0' border='0' class='float-card'><tr><td class='left' valign='bottom'>".$button_buy."</td></tr><tr><td class='left'><p>Артикул: <b class='big'>".$title."</b></p><p>Цена: ".$price."</p></td></tr><tr><td>".$text."</td></tr><tr><td>".$discount."<p style='margin: 10px 0 0 -30px;'>".$delivery."</p></td></tr></table>";?>
