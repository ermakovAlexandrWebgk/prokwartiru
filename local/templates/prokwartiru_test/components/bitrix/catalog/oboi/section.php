...
<? 
   $templ="";
   if($SECTION_TOP==45) $templ="freski";
   if($SECTION_ID==3733||$SECTION_ID==3710||$SECTION_ID==3711) $templ="faktury";
   //if($SECTION_ID==3730) $templ="interiers";
   //if($SECTION_ID==3730) $SECTION_ID==3723;
?>
<?$APPLICATION->IncludeComponent(
