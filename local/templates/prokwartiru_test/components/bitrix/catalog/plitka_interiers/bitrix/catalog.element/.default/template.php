...
?>
<!-- Конец Вид товара -->	
			Название: <b class='big'><?=$arResult["NAME"]?></b>
...
<?
		...
		if($arResult['PROPERTIES']['UPAK_KG']['VALUE']) { if($arResult['PROPERTIES']['UPAK_PCS']['VALUE']||$arResult['PROPERTIES']['UPAK_KBM']['VALUE']) $text=$text." / "; $text=$text."<b>".$arResult['PROPERTIES']['UPAK_KG']['VALUE']." кг</b>"; }
		$text=$text."</p>";
		$text=$text."</div>";
?>
<?endif;?>
...
<!-- Доставка товара -->
<? 
    $delivery="<div style='margin: 20px 0 0px 0px;'><p>Срок поставки:</p><p><a href='/about/delivery/'><img src='".SITE_TEMPLATE_PATH."/images/delivery.png' title='Доставка' alt='Доставка'  style='width:45px; margin-top:5px; margin-right:10px; float:left;' /></a> доставка &ndash; <b>1 день</b></p></div>";
?>
<?=$delivery?>
...
<?=$button_discount?>
<!-- Конец Получить Скидку -->

<!-- Кнопка 3d-проект в подарок -->
	<?$button_3d="<br /><a href='/catalog/plitka/3d-project.php'><img src='".SITE_TEMPLATE_PATH."/images/3d.png' title='3d-проект в подарок' alt='3d-проект в подарок' style='width:120px; height:47px; margin-top:10px; margin-right:10px;' /></a>";?>
<?=$button_3d?>
<!-- Конец 3d-проект в подарок -->

<!-- Кнопка Ламинат -->
	<?$button_laminat="<img src='".SITE_TEMPLATE_PATH."/images/laminat.png' title='Каждая 10-я пачка ламината бесплатно' alt='Каждая 10-я пачка ламината бесплатно' style='width:120px; height:47px; margin-top:10px;' />";?>
<?=$button_laminat?>
<!-- Конец Ламинат -->
