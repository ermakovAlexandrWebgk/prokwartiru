...
<?
  ...
  if($type_item = $type->GetNext()){
	...
	$page_title=$page_title."<a href='/catalog/plitka/index.php?SECTION_ID=".$section["ID"]."'><span>".$section["NAME"]."</span></a> / ";
...
<table style_="background-color: white; width: 725px; border: 1px solid #8E8B86; padding: 5px 0 10px 10px;">
