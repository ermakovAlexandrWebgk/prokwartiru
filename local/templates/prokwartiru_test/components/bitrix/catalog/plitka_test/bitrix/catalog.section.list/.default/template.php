...
$arFilterDop=Array();
if($section&&$section!=1) $arFilterDop=Array('SECTION_ID'=>$section);
$arFilterDop1=Array();
if($filter_price) $arFilterDop1=Array('UF_PRICE' => $filter_price);
$arFilterDop2=Array();
if($filter_structure) $arFilterDop2=Array('UF_STRUCTURE' => $filter_structure);
//global $arFilterDop;
//$arFilter = array_merge($arFilterMain, $arFilterDop, $arFilterDop1);
$arFilter = array_merge($arFilterMain, $arFilterDop, $arFilterDop1, $arFilterDop2);
// Конец ФИЛЬТР
?>
