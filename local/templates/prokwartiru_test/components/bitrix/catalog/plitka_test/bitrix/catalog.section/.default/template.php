...
<!-- Формирование и форматирование Описания для всплывающей карточки товара -->
	<?$title_text="<table cellspacing='0' cellpadding='0' border='0' class='float-card'><tr><td valign='top' style='min-width: 250px;'>".$button_buy."<p><b class='big'>".$title_type."</b></p><p>Название: <b class='big'>".$title."</b></p><p style='padding-top: 4px;'>Цена: ".$price."</p><p style='padding-top: 4px;'><nobr>Наличие: <b class='orange'>".$quantity."</b></nobr></p></td>";          
