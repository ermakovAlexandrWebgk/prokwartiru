...
<script><!--{document.writeln('<div style="background-color: red; height: 100px; width: ',width/10,'px;"></div>');}//--></script>
...
<!-- Заголовок -->
      <div class="item-title" style="text-align: center; width: <?=$cardWidth;?>px; height: 30px;"><a href="<?=$arElement['DETAIL_PAGE_URL']?>" title="<?=$arElement['NAME']?>"><b><?=$arElement["NAME"]?></b></a><?=$sticker?></div>
<!-- Конец Заголовок -->
...
<!-- Формирование и форматирование Описания для всплывающей карточки товара -->
	<?$title_text="<table cellspacing='0' cellpadding='0' border='0' class='float-card'><tr><td colspan='2'><p><b class='big'>".$title_type."</b></p><p>Название: <b class='big'>".$title."</b></p></td></tr><tr><td class='left'>Цена: ".$price."</td><td class='right'>".$button_compare."</td></tr><tr><td class='left'>Наличие: <b class='orange'>".$quantity."</b></td><td class='right'>".$button_buy."</td></tr><tr><td colspan='2'>".$text."</td></tr></table>";?>
...
<div class="item-image" style="width:<?=$cardWidth;?>px; height: auto; text-align: center;">
	...
	<a class="fancybox" data-fancybox-group="gallery" href="#inline_<?=$arElement['ID']?>"><img src="<?if($cardCols==2):?><?=$arElement['DETAIL_PICTURE']['SRC']?><?elseif($arElement['PREVIEW_IMG']['SRC']):?><?=$arElement['PREVIEW_IMG']['SRC']?><?else:?><?=SITE_TEMPLATE_PATH?>/images/default150.gif><?endif?>" style="max-width:<?=$cardWidth;?>px; max-height: 300px;" alt="<?=$arElement["NAME"]?>" title="Открыть картинку" id="catalog_list_image_<?=$arElement['ID']?>"/></a>
...
<script>
  <!--
  {
    document.writeln('<div id="inline_<?=$arElement['ID']?>" style="width: ',width/10,'px; height: 465px; display: none; text-align: center;">');
  }
  //-->
</script>
		<table style="width:860px; height:465px;">
<tr><td valign="top" style="text-align:center;"><img src="<?if($arElement['DETAIL_PICTURE']['SRC']):?><?=$arElement['DETAIL_PICTURE']['SRC']?><?else:?><?=SITE_TEMPLATE_PATH?>/images/default300.gif<?endif?>" alt="<?=$arElement['NAME']?>" style="<?if($arElement['DETAIL_PICTURE']['WIDTH']<=$arElement['DETAIL_PICTURE']['HEIGHT']):?>max-width:560px; max-height:455px;<?else:?>max-width:860px; max-height:240px;<?endif?>"/>
<?if($arElement['DETAIL_PICTURE']['WIDTH']<=$arElement['DETAIL_PICTURE']['HEIGHT']):?></td><td valign="top" style="width: 300px;" /><?else:?></td></tr><tr><td valign="top" style="text-align:center; height: 215px; vertical-align: bottom;"><?endif?><?=$title_text?></td></tr></table>
	</div>
