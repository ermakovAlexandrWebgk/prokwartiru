...
<?
	...
	$filter_price=$_REQUEST["form_dropdown_PRICE"];
	$IBLOCK_ID=1;
...
<!-- Конец Фильтр -->
  ...
  <?
    ...
    $listCatalogFabrika=CIBlockSection::GetList(array('left_margin'=>'asc'), $arFilterMain, false, $arSelect=array('UF_FABRIKA', 'UF_NEWCATALOG', 'UF_HIT', 'UF_SALE')); 
...
<?
// ФИЛЬТР
$arFilterMain=Array('ACTIVE' => 'Y', 'IBLOCK_ID' => $IBLOCK_ID, 'SECTION_ID' => $section, 'UF_PRICE' => $filter_price);
//$arFilterMain=Array('ACTIVE' => 'Y', 'IBLOCK_ID' => $IBLOCK_ID, 'SECTION_ID' => $section, 'UF_FABRIKA' => 3311 );
//global $arFilterDop;
//$arFilter = array_merge($arFilterMain, $arFilterDop);
// Конец ФИЛЬТР
?>
  ...
  <?
    $listCatalogType=CIBlockSection::GetList(array('left_margin'=>'asc'), $arFilterMain, false, $arSelect=array('UF_FABRIKA', 'UF_NEWCATALOG', 'UF_HIT', 'UF_SALE', 'UF_PRICE')); 
