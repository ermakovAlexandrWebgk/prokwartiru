...
<div class="item"><a href="<?=$arItem["PROPERTIES"]["URL"]["VALUE"]?>"><img class="preview_picture" border="0" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" width="580px" height="430" alt="<?=$arItem["NAME"]?>" title="<?=$arItem["NAME"]?>" style="float:left" /></a></div>
<?endforeach;?>
			</div>
		</div>
	</div>
