...
//ambu
if($arItem["DETAIL_PICTURE"]) $picture=CFile::GetPath($arItem["DETAIL_PICTURE"]); else $picture=CFile::GetPath($arItem["PREVIEW_PICTURE"]);
$arItem["PICTURE"]["SRC"]=$picture;
$arItem["PICTURE"]["WIDTH"]="200";
$arItem["PICTURE"]["HEIGHT"]="200";
//$arItem["PREVIEW_PICTURE"]["SRC"]="";
//$arItem["PREVIEW_PICTURE"]=$arItem["DETAIL_PICTURE"];
//$arItem["PREVIEW_PICTURE"]["WIDTH"]=$arItem["DETAIL_PICTURE"]["WIDTH"];
//$picturePreview=CFile::GetPath($arItem["PREVIEW_PICTURE"]);
//$arItem["TITLE"]=$picturePreview;

//ambu


	call_user_func("__photo_template_".$sTemplateName, $arItem, $arParams, $this); // ambu вывод картинок
//}
endforeach;
?>
	<div class="empty-clear"></div>
