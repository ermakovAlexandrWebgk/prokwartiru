...
<table>
    <tr>
        <td>Подобрать каталоги по цене:&nbsp;</td>
        <td><?
            ...
            //    " class=\"inputselect\" style=\"border: 1px solid red;\" "  // стиль выпадающего списка
            //    );            
            ?>
        ...
        <!--td><input type="submit" name="filter" value="Найти" style="background-color: #8e8b86; color: white; border: 0px;"></td-->
    </tr>
</table>
</form>
</div>
