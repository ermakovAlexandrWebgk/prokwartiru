...
<div id="panel"><?$APPLICATION->ShowPanel();?></div>
	<div id="wrapper">
    	<div id="header">
        	<a class="logo png" href="http://prokwarti.ru/" title="На главную страницу"></a>
        	<div style="float:right; width: 100px; padding: 11px 12px 0 0;"><a href="/personal/" title="" style="text-decoration:none;">Личный кабинет</a></div>
...
<table /*width="100"*/ border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td <?if($arSite=="/catalog/oboi/"):?>class="twal_on"<?else:?>class="twal1"<?endif?> ><a href="/catalog/oboi/">ОБОИ<br /><span style="font-size: 12px; font-weight: bold;">30100 видов</span></a></td>
    <td <?if($arSite=="/catalog/plitka/"):?>class="twal_on"<?else:?>class="twal2"<?endif?> ><a href="/catalog/plitka/">ПЛИТКА<br /><span style="font-size: 12px; font-weight: bold;">17300 коллекций</span></a></td>
...
<!--?if($arSite=="/catalog/plitka/"):?-><p style="text-align: center; margin-top: -5px; padding-bottom: 6px; font-size: 14px;"><b>Дизайн-проект 3D - в ПОДАРОК!</b></p><-?endif?-->
</div>
<!-- top-menu close -->
